...
import 'component/purchase_printer_dialog.dart';



class SalesPrinterDialog extends StatefulWidget {
  final List<CategoryProductData> selectedProducts;
...
class _SalesPrinterDialogState extends State<SalesPrinterDialog> {
  ...
  void _print() async {
    ...
    try {
      ...
      // Print header
      bytes += generator.text('Al Kaderia Express',
      ...
      bytes += generator.text('3rd loor, MANAMA MW Heights, House 25/B, Taltola Rd, Dhaka-1219',
          styles: const PosStyles(align: PosAlign.center));

      bytes += generator.text('Val Reg No. #: ${'001035361-0202'}',
          styles: const PosStyles(align: PosAlign.center));

      bytes += generator.text('Help Line: ${'01844022207'}',
          styles: const PosStyles(align: PosAlign.center));

      bytes += generator.text('Invoice No: ${'3250113105055'}',
          styles: const PosStyles(align: PosAlign.center));
      ...
      for (int i = 0; i < widget.selectedProducts.length; i++) {
        ...
        bytes += generator.row([
          ...
          PosColumn(text: '${product.totalAmount}', width: 3),
        ]);
      }
      ...
      bytes += generator.row([
        ...
        PosColumn(text: '${widget.grandTotal ?? "0.00"}', width: 5, styles: const PosStyles(align: PosAlign.right)),
      ]);
      ...
      bytes += generator.row([
        ...
        PosColumn(text: widget.discountAmount != 'null' ? widget.discountAmount.toString() : '0.00', width: 5, styles: const PosStyles(align: PosAlign.right)),
      ]);
      ...
      bytes += generator.row([
        ...
        PosColumn(text: '${widget.totalAmount ?? "0.00"}', width: 5, styles: const PosStyles(align: PosAlign.right)),
      ]);

      bytes += generator.row([
        PosColumn(text: 'Collected:', width: 7, styles: const PosStyles(align: PosAlign.left)),
        PosColumn(text: widget.collectedAmount != 'null' ? widget.collectedAmount.toString() : '0.00', width: 5, styles: const PosStyles(align: PosAlign.right)),
      ]);

      bytes += generator.row([
        PosColumn(text: 'Change:', width: 7, styles: const PosStyles(align: PosAlign.left)),
        PosColumn(text: widget.changeAmount != 'null' ? widget.changeAmount.toString() : '0.00', width: 5, styles: const PosStyles(align: PosAlign.right)),
      ]);

      bytes += generator.row([
        PosColumn(text: 'Paid By:', width: 7, styles: const PosStyles(align: PosAlign.left)),
        PosColumn(text: widget.paymentVaiName ?? '', width: 5, styles: const PosStyles(align: PosAlign.right)),
      ]);
...
class _SalesPrinterScreenState extends State<SalesPrinterScreen> {
  ...
  Future<void> generatePdfAndShare() async {
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(widget.grandTotal.toString(), style: const pw.TextStyle(fontSize: 12)),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  pw.Text(widget.discountAmount.toString(), style: const pw.TextStyle(fontSize: 12)),
                ],
              ),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(widget.totalAmount.toString(), style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold)),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  pw.Text(widget.collectedAmount != 'null' ? widget.collectedAmount.toString() : "0.00", style: const pw.TextStyle(fontSize: 12)),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  pw.Text(widget.changeAmount != 'null' ? widget.changeAmount.toString() : "0.00", style: const pw.TextStyle(fontSize: 12)),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  pw.Text(widget.paymentVaiName != 'null' ? widget.paymentVaiName.toString() : "", style: const pw.TextStyle(fontSize: 12)),
                ],
              ),
    ...
    final file = File("${output.path}/al_kaderia.pdf");
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    GlobalText(
                      str: '3rd loor, MANAMA MW Heights, House 25/B, Taltola Rd, Dhaka-1219',
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (ctx, index){
                          return PrintTableListValueWidget(
                            ...
                            fiveColumn: '${widget.selectedProducts[index].totalAmount}',
                          );
                        }
                    ),
                    ...
                    PrintCardBoardWidget(
                        ...
                        value1: "${widget.grandTotal ?? "0.00"}",
                        value3: widget.discountAmount ?? "0.00",
                    ),
                    sizeBoxH(10),
                    Container(
                      height: 1,
                    ...
                    PrintCardBoardWidget(
                      ...
                      name4: "Change",
                      name5: "Paid By",
                      value1: "${widget.totalAmount ?? "0.00"}",
                      value3: widget.collectedAmount != 'null' ? widget.collectedAmount : "0.00",
                      value4: widget.changeAmount != 'null' ? widget.changeAmount : "0.00",
                      value5: widget.paymentVaiName != 'null' ? widget.paymentVaiName : "",
                    ),
                  ],
                ),
              ),
                  ...
                  onTap: (){
                    ...
                    Get.dialog(Dialog(
                        ...
                        child: SalesPrinterDialog(
                          salesModel: widget.salesModel,
                          selectedProducts: widget.selectedProducts,
                          //superUserProfileListData: widget.superUserProfileListData,
                          grandTotal: widget.grandTotal,
                          totalAmount: widget.totalAmount,
                          discountAmount: widget.discountAmount,
                          collectedAmount: widget.collectedAmount.toString(),
                          changeAmount: widget.changeAmount.toString(),
                          paymentVaiName: widget.paymentVaiName.toString(),
